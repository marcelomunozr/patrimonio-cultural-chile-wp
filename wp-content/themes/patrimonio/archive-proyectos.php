...
<section class="contenido-boxes row proyectos">
  ...
  <div class="container">
    ...
    <div class="row posts-zone">
      ...
      $query = new WP_Query( array( 'post_type' => 'proyectos', 'posts_per_page' => 6, 'paged' => $paged));//'categoria' => 'eventos,sesiones,todos', 'posts_per_page' => 6, 
